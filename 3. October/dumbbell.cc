...
int main (int argc, char *argv[])
{
 ...
 // Install Internet Stack
  ...
  anim.SetConstantPosition(c.Get(1), 10.0, 50.0); 
  anim.SetConstantPosition(c.Get(4), 35.0, 30.0);
  anim.SetConstantPosition(c.Get(5), 65.0, 30.0);
  anim.SetConstantPosition(c.Get(2), 90.0, 10.0);
  anim.SetConstantPosition(c.Get(3), 90.0, 50.0);
