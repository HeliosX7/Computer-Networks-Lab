...
//
  ...
  anim.SetConstantPosition(n.Get(0), 10.0, 10.0);
  anim.SetConstantPosition(n.Get(1), 10.0, 50.0);
  anim.SetConstantPosition(n.Get(2), 50.0, 50.0);
  anim.SetConstantPosition(n.Get(3), 50.0, 10.0);
